...
var customer_service = require('./customer_service');
...
weixin.textMsg(function (msg) {
    ...
    var resMsg = {
        ...
        msgType: 'text',
        content: 'En Study还在成长中，欢迎您给出宝贵的意见，有任何疑问请回复 help 或 study',
        funcFlag: 0
    };
    ...
    if (!!keywords.exactKey[msgContent]) {
        ...
        if (msgContent == 'STUDY') {
            customer_service.onStartEvent(msg);
            flag = false;
